...
public class PostService {
    ...
    // 게시글 수정 — @Modifying 단건 UPDATE, 트랜잭션 불필요
    @Transactional
    ...
    // 게시글 단건 조회 — JOIN FETCH 한 방, 트랜잭션 불필요
    ...
    // 카테고리별 게시글 목록 — QueryDSL 한 방, 트랜잭션 불필요
    ...
    // 카테고리별 게시글 목록 (페이징) — QueryDSL 한 방, 트랜잭션 불필요
