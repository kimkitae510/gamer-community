...
public class CategoryService {
    ...
    // 부모 카테고리 목록 조회 — 단순 SELECT, 트랜잭션 불필요
    ...
    // 자식 카테고리 목록 조회 — SELECT + JOIN FETCH, 트랜잭션 불필요
    ...
    // 장르별 카테고리 목록 조회 — 단순 SELECT, 트랜잭션 불필요
    ...
    // 자식 카테고리 이름 수정 — @Modifying 단건 UPDATE → 트랜잭션 필요
    @Transactional
    ...
    // 자식 카테고리 장르 수정 — delete + save 여러 개 → 트랜잭션 필요
    @Transactional
    ...
    // 자식 카테고리 이미지 교체 — @Modifying UPDATE + S3 → 트랜잭션 필요
    @Transactional
    ...
    // 자식 카테고리 삭제 — delete + @Modifying → 트랜잭션 필요
    @Transactional
    ...
    // 단일 자식 카테고리 조회 — 단건 SELECT + 장르 SELECT, 트랜잭션 불필요
    ...
    // 신설 게시판 목록 조회 — 단순 SELECT, 트랜잭션 불필요
    ...
    // 부모 카테고리별 게임 목록 (정렬 + 페이징) — 단순 SELECT, 트랜잭션 불필요
    ...
    // 장르별 카테고리 목록 (정렬 + 페이징) — 단순 SELECT, 트랜잭션 불필요
